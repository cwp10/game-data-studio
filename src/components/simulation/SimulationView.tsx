...
import { RotateCcw, Copy, Sparkles, Save, Plus, Swords, Calculator, FileDown, Dice5, Zap, Trash2 } from "lucide-react";
...
type Mode = "saved" | "stat" | "combat" | "gacha" | "dps";
  ...
  return (
    <div className="flex flex-1 overflow-hidden">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        <ContentHeader title={mode === "stat" ? "스탯 계산기" : mode === "combat" ? "전투 시뮬레이션" : mode === "gacha" ? "가챠 시뮬레이션" : mode === "dps" ? "DPS 빌드 비교" : (selectedSim?.name ?? "새 시뮬레이션")}>
          <PillTab
            tabs={[{ id: "saved", label: "저장된 시뮬" }, { id: "stat", label: "스탯 계산기" }, { id: "combat", label: "전투 시뮬" }, { id: "gacha", label: "가챠" }, { id: "dps", label: "DPS" }]}
            active={mode}
