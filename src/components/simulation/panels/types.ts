...
export interface Unit { name: string; hp: number; atk: number; def: number; speed: number; critRate?: number; critMult?: number; skills?: Skill[]; extra?: Record<string, number>; }
...
export const EMPTY_UNIT: Unit = { name: "", hp: 0, atk: 0, def: 0, speed: 100, critRate: 0, critMult: 1.5 };
